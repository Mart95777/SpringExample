...
public class Example08 extends JFrame {
	JPanel mainPanel;
	JTextArea jta;
	JLabel mainFirstLabel = new JLabel("<html>Example 08 , Bean postprocessor"
			+ "<br />note, that apart from additional class, only additional bean in xml is needed."
			+ "<br />...</html>");
...
// CONSTRUCTOR
public Example08(final String pathToApp, final String pathToExample){
	super("Spring Example - Example 08");
