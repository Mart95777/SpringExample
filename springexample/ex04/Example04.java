...
public class Example04 extends JFrame {
	JPanel mainPanel;
	JTextArea jta;
	JLabel mainFirstLabel = new JLabel("Example 04 , autowire");
...
// CONSTRUCTOR
public Example04(final String pathToApp, final String pathToExample){
	...
	jButtonStart.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent e) {
    		...
    		// constructor autowire not working... cause of 3 points, not 1?
